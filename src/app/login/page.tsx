import { login, signup, loginWithOAuth } from '@/app/auth/actions'
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <form action={loginWithOAuth.bind(null, 'google')}>
              <Button 
                type="submit" 
                variant="outline" 
                className="w-full h-12 font-semibold bg-white/5 hover:bg-white/10 border-white/10 text-white gap-3"
              >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-3 text-muted-foreground uppercase tracking-widest font-semibold">or</span>
            </div>
          </div>
          ...
          <form className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="username" className="text-sm font-semibold text-white/80">Username <span className="text-muted-foreground text-xs">(for new accounts)</span></Label>
              <Input 
                id="username" 
                name="username" 
                type="text" 
